                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <textarea type="text" class="form-control" name="current_address" value="{{old('current_address')}}" placeholder="Current Address"></textarea>
                            <div style="color: red;">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <textarea type="text" class="form-control" name="permanent_address" value="{{old('permanent_address')}}" placeholder="Permanent Address"></textarea>
                            <div style="color: red;">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <textarea type="text" class="form-control" name="qualification" value="{{old('qualification')}}" placeholder="Qualification"></textarea>
                            <div style="color: red;">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <textarea type="text" class="form-control" name="work_experience" value="{{old('work_experience')}}" placeholder="Work Experience"></textarea>
                            <div style="color: red;">
