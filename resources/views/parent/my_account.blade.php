                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" class="form-control" name="occupation" placeholder="Occupation" value="{{old('occupation', $user->occupation)}}">
                            <div style="color: red;">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" class="form-control" name="address" placeholder="Address" value="{{old('address', $user->address)}}" required>
                            <div style="color: red;">
